                ...
                if ((gridX == -1) || (gridY == -1)) {
                    ...
                    if ((myPanel.mouseDownGridX != gridX) || (myPanel.mouseDownGridY != gridY)) {
                        ...
                        if ((gridX == 0) || (gridY == 0)) {
                            ...
                            colorPalette[1] = Color.MAGENTA;
                            colorPalette[2] = Color.BLACK;
                            colorPalette[3] = new Color(0x964B00);
                            colorPalette[4] = new Color(0xB57EDC);
                           
                            Color currentColor = myPanel.colorArray[myPanel.mouseDownGridX][myPanel.mouseDownGridY];
                           
                            for(int i =0; i <5; i++){
                                if(colorPalette[i].equals(currentColor)){
                                    cs = i;
                                    break;
                                }
                                else cs = 6;
